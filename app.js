...
// will check if the access token has the "elevator.call" scope.
app.get("/protected/callElevator", passport.authenticate(WebAppStrategy.STRATEGY_NAME), function(req, res){
	if(WebAppStrategy.hasScope(req, "elevator.call")){
...
// will check if the access token has the "elevator.service" scope.
app.get("/protected/serviceMode", passport.authenticate(WebAppStrategy.STRATEGY_NAME), function(req, res){
	if(WebAppStrategy.hasScope(req, "elevator.service")){
...
// will check if the access token has the "elevator.stop" scope.
app.get("/protected/stopElevator", passport.authenticate(WebAppStrategy.STRATEGY_NAME), function(req, res){
	if(WebAppStrategy.hasScope(req, "elevator.stop")){
